                  ...
                  <div class="mb-3 h-100">
                    <div class="relative mx-auto p-carousel-content">
                      <div class="p-carousel-body mb-3">
                        ...
                        <div
                          class="d-flex flex-column gap-2 px-4"
                          style="font-family: Axiforma"
                        >
                          <span
                            class="text-start"
                          ...
                          <span
                            class="text-start"
                            style="font-size: 0.8em; color: #515166"
                          >
                      ...
                      <div
                        class="p-carousel-footer w-100 mt-2 px-4"
                      ...
                      >
                        ...
                        >
                          <span
                            @click="
                              redirectTo(
                                '/course-detail/' + slotProps.data.id,
                                'course-hero'
                              )
                            "
                            class="more-info p-carousel-footer__link text-center"
                            style="cursor: pointer; color: #515166"
                            >Mas información</span
                          >
                          <button
                            class="btn-course gap-1"
                          ...
                          >
                            ...
                            <span class="btn-course-price" style="color: white"
                              >$ {{ slotProps.data.priceUsd }} (S/.{{
                                slotProps.data.pricePen
                              }})</span
                            >
                          </button>
                        </div>
